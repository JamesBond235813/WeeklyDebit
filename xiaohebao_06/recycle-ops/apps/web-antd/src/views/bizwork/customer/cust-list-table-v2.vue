...
defineOptions({ name: 'CustListTableV2' });
...
<template>
  ...
  <div v-if="!isObserverRole" class="m-1 mt-5 w-full">
    ...
    <Button
      ...
      @click="batchAssign"
      v-if="
        hasMaintainRole && favoriteFlag === null && !publicPoolOnly && !selfOnly
      "
    >
      分配
    </Button>
    <Button
      ...
      v-if="
        hasMaintainRole &&
        favoriteFlag !== null &&
        favoriteFlag !== FavoriteTypeEnum.MY_CUST
      "
    >
      移入我的客户
    </Button>
    <Button
      ...
      v-if="
        hasMaintainRole &&
        favoriteFlag !== null &&
        favoriteFlag !== FavoriteTypeEnum.KEY_CUST
      "
    >
      移入重点客户
    </Button>
    <Button
      ...
      v-if="
        hasMaintainRole &&
        favoriteFlag !== null &&
        favoriteFlag !== FavoriteTypeEnum.NORMAL
      "
    >
      移入再分配客户
    </Button>
    <Button
      ...
      v-if="favoriteFlag !== null || selfOnly"
    >
      退回
    </Button>
  </div>
