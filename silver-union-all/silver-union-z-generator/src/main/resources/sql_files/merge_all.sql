...
CREATE TABLE `loan_record` (
  ...
  `owner_user_id` bigint DEFAULT NULL COMMENT '归属人ID',
  `owner_dept_id` bigint DEFAULT NULL COMMENT '归属部门ID',
  `loan_amount` decimal(12,2) DEFAULT '0.00' COMMENT '放款金额',
  `loan_term` int DEFAULT NULL COMMENT '期限',
  `service_fee_rate` decimal(8,4) DEFAULT '0.0000' COMMENT '服务费费率',
  `receivable_amount` decimal(12,2) DEFAULT '0.00' COMMENT '应回款金额',
  `repayment_amount` decimal(12,2) DEFAULT '0.00' COMMENT '已回款金额',
  `loan_status` varchar(32) NOT NULL DEFAULT 'DISBURSED' COMMENT '状态',
  `remark` varchar(512) DEFAULT NULL COMMENT '备注',
  `gmt_create` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='授信放款记录表';
