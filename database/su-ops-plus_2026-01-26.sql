...
CREATE TABLE `loan_record` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `customer_id` bigint NOT NULL COMMENT '客户ID',
  `owner_user_id` bigint DEFAULT NULL COMMENT '数据归属用户ID',
  `owner_dept_id` bigint DEFAULT NULL COMMENT '数据归属部门ID',
  `loan_amount` decimal(18,2) NOT NULL COMMENT '放款金额',
  `loan_term` int NOT NULL COMMENT '期限',
  `service_fee_rate` decimal(10,4) NOT NULL DEFAULT '0.0000' COMMENT '服务费费率',
  `receivable_amount` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '应回款金额',
  `repayment_amount` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '已回款金额',
  `loan_status` varchar(32) NOT NULL DEFAULT 'DISBURSED' COMMENT '放款状态',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='授信放款记录';
